...
// global variable to save the state of the lock
boolean palettochiuso = false;
   ...
   if (pressed[i]) {
     switch(i){
       ...
       case 1:
         ...
         if ( palettochiuso == true ){
           Serial.println("The door is locked, we're going to open it!");
           turn_key("close");
         }else{
           Serial.println("The door is already open, do nothing.");
       ...
       case 2:
         ...
         if ( palettochiuso == false ){
           Serial.println("The door is open and we want to lock it.");
           timer_before_closing();
           turn_key("close");
           Serial.println("Door closed");

         }else{
           Serial.println("The door is already locked, do nothing.");
           theaterChase(random_color(),50,25);
           fade_up(200, 10, 40, 0, 0); //hi red
         }
         break;
